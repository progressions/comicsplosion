...
set :repository, "svn+ssh://#{user}@#{server}/home/#{user}/svn/#{application}/trunk" 
role :web, server
role :app, server
...
desc "Creates symbolic link /public/image/ to shared folder with images"
task :share_files do
	run "ln -s #{shared_path}/page #{current_release}/public/pages && 
	     ln -s #{shared_path}/comic #{current_release}/public/comics &&
	     ln -s #{shared_path}/user #{current_release}/public/users &&
	     ln -s #{shared_path}/user #{current_release}/public/thumbnails"
end
